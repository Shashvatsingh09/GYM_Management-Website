...
<body class="w3-black">
 <a href="<?=base_url("Welcome/signup")?>" style=" position: absolute;right: 5px;"><button class="w3-button w3-white w3-padding-large w3-hover-black">SignUp</button></a>
 <a href="#" style=" position: absolute;right: 110px;"><button onclick ="login()" class="w3-button w3-white w3-padding-large w3-hover-black">Login</button></a>
 <div id="login" style="display:none;">
   <a href="<?=base_url("Welcome/login")?>"style="width: 30px; position: absolute;right: 210px;top:90px"><button class="w3-button w3-white w3-padding-large w3-hover-black">User Login</button></a>
   <a href="<?=base_url("Welcome/admin")?>"style=" width: 30px;position: absolute;right: 210px;top:50px"><button class="w3-button w3-white w3-padding-large w3-hover-black">Admin Login</button></a>
 </div>
 ...
 <nav class="w3-sidebar w3-bar-block w3-small w3-hide-small w3-center">
  ...
  <a href="<?=base_url("Welcome/shop")?>" class="w3-bar-item w3-button w3-padding-large w3-hover-black">
...
<div class="w3-row-padding" style="margin:0 -16px" id="membership">
  <div class="w3-half w3-margin-bottom">
    ...
    <li class="w3-light-grey w3-padding-24">
      <a href="<?=base_url('Welcome/signup')?>"><button class="w3-button w3-white w3-padding-large w3-hover-black">Sign Up</button></a>
    </li>
  </ul>
</div>
...
<div class="w3-padding-64 w3-content w3-text-grey" id="contact">
  ...
  <form action="<?=base_url("Welcome/contact")?>" method="post">
    <p><input class="w3-input w3-padding-16" type="text" id="NAME" name="name" placeholder="Name" required></p>
    <p><input class="w3-input w3-padding-16" type="text" id="EMAIL" name="email" placeholder="Email"required></p>
    <p><input class="w3-input w3-padding-16" type="text" id="SUBJECT" name="sub" placeholder="Subject"required></p>
    <p><input class="w3-input w3-padding-16" type="text" id="MESSAGE" name="msg" placeholder="Message"required></p>
    <p>
